...
\begin{figure}[h]
	\centering
    \subfloat[GNOME desktop okruženje]{{\includegraphics[height=6cm,width=7cm]{gnome} }}
    \qquad
    \subfloat[KDE desktop okruženje]{{\includegraphics[height=6cm,width=7cm]{kde} }}
\end{figure}
\begin{figure}[h]
	\centering
    \subfloat[XFCE desktop okruženje]{{\includegraphics[height=6cm,width=7cm]{xfce} }}
    \qquad
    \subfloat[LXDE desktop okruženje]{{\includegraphics[height=6cm,width=7cm]{lxde} }}
\end{figure}